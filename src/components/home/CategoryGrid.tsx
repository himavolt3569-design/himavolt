...
export default function CategoryGrid() {
  return (
    <section className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div className="grid grid-cols-4 gap-2 sm:gap-4 md:grid-cols-9">
        {BROWSE_CATEGORIES.map((c) => {
          ...
          return (
            <Link
              ...
              className="group flex flex-col items-center gap-2 rounded-2xl py-2 transition-colors hover:bg-[var(--surface)]"
            >
              <span
