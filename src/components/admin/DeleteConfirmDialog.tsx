      ...
      {open && (
        <>
          ...
          >
            <button
              onClick={onCancel}
              className="absolute right-4 top-4 rounded-lg p-1 text-[var(--text-3)] hover:bg-[var(--surface-alt)] transition-colors"
            >
              <X className="h-4 w-4" />
            </button>
            ...
            <p className="mt-1.5 text-sm text-[var(--text-3)] leading-relaxed">{description}</p>

            <div className="mt-5 flex gap-3">
              <button
                onClick={onCancel}
                disabled={loading}
                className="flex-1 rounded-xl border border-[var(--border)] bg-[var(--surface-alt)] py-2.5 text-sm font-medium text-[var(--text-2)] transition-all hover:bg-[var(--surface-alt)] disabled:opacity-50"
              >
                Cancel
              </button>
              <button
