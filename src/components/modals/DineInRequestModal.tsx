            ...
            <div className="px-6 pb-6 pt-2 space-y-2">
              {order.status === "PENDING" ? (
                <>
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      ...
                      className="flex items-center justify-center gap-1.5 rounded-xl bg-[var(--text-1)] py-3.5 text-sm font-bold text-[var(--canvas)] hover:opacity-90 transition-all active:scale-[0.98]"
                    >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={onClose}
                    className="flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-[var(--text-1)] py-3.5 text-sm font-bold text-[var(--canvas)] hover:opacity-90 transition-all"
                  >
                    Close
                  </button>
                </div>
