          ...
          >
            ...
            <div className="mt-6 flex flex-col gap-2.5">
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-[var(--text-1)] px-6 py-3 text-sm font-bold text-[var(--canvas)] hover:opacity-90 active:scale-[0.97] transition-all"
              >
                Track Order
