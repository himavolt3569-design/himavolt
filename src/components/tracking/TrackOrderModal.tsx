              ...
              <div className="p-5">
                <form onSubmit={handleTrack} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 rounded-xl bg-[var(--text-1)] py-3.5 text-[15px] font-bold text-[var(--canvas)] shadow-md hover:opacity-90 disabled:opacity-50 transition-all active:scale-[0.98]"
                  >
                    {loading ? (
