  ...
  return (
    <group ref={ref} position={position} scale={scale}>
      ...
      <mesh position={[0, 0.05, 0]}>
        ...
        <meshStandardMaterial color="#eaa94d" roughness={0.4} />
      </mesh>
      {/* Cheese */}
      <mesh position={[0, 0.18, 0]}>
        <boxGeometry args={[2.2, 0.08, 1.4]} />
        <meshStandardMaterial color="#f1c980" roughness={0.35} />
      </mesh>
      {/* Meat/patty */}
  ...
  return (
    <group ref={ref} position={position} scale={scale}>
      ...
      <mesh position={[0, 0, 0]}>
        ...
        <meshStandardMaterial color="#e58f2a" roughness={0.4} />
      </mesh>
      {/* Cream layer */}
      <mesh position={[0, 0.3, 0]}>
      ...
      <mesh position={[0.4, 1, 0]}>
        ...
        <meshStandardMaterial color="#f1c980" />
      </mesh>
      {/* Flame */}
      <mesh position={[0.4, 1.22, 0]}>
        <coneGeometry args={[0.06, 0.12, 8]} />
        <meshBasicMaterial color="#eaa94d" />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group ref={ref} position={position} scale={scale}>
      ...
      <mesh position={[0, 0, 0]}>
        ...
        <meshStandardMaterial color="#f1c980" roughness={0.5} />
      </mesh>
      {/* Frosting swirl */}
      <mesh position={[0, 0.5, 0]}>
        <coneGeometry args={[0.55, 0.6, 16]} />
        <meshStandardMaterial color="#e58f2a" roughness={0.35} />
      </mesh>
      {/* Cherry */}
      <mesh position={[0, 0.85, 0]}>
        <sphereGeometry args={[0.1, 10, 10]} />
        <meshStandardMaterial color="#eaa94d" />
      </mesh>
    </group>
  );
}
...
export default function FloatingFoodShapes({
  ...
  return (
    <group>
      {/* Donuts */}
      <Donut position={[-5, 3, -3]} color="#D4A052" icingColor="#e58f2a" speed={0.35} rotSpeed={0.8} scale={0.5} scrollProgress={scrollProgress} />
      <Donut position={[5.5, -1, -5]} color="#C8903C" icingColor="#6366F1" speed={0.45} rotSpeed={0.7} scale={0.35} scrollProgress={scrollProgress} />
      <Donut position={[-2, -4, -7]} color="#D4A052" icingColor="#eaa94d" speed={0.3} rotSpeed={0.6} scale={0.25} scrollProgress={scrollProgress} />
      <Donut position={[3, 4, -6]} color="#B8843A" icingColor="#eaa94d" speed={0.4} rotSpeed={0.9} scale={0.3} scrollProgress={scrollProgress} />
