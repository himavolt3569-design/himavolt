...
function StatCard({
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl border border-brand-100 bg-white p-5 shadow-sm transition-all duration-200 hover:shadow-md"
    >
...
function AuditRow({ log, isNew }: { log: AuditLog; isNew?: boolean }) {
  ...
  return (
    <motion.div
      ...
      className={`group border-b border-gray-50 transition-all duration-200 hover:bg-brand-50/60 ${
        isNew ? "bg-brand-100/30" : ""
      }`}
    >
      <button
        type="button"
      ...
      >
        ...
        <Eye className="h-3.5 w-3.5 flex-shrink-0 text-gray-300 transition-all duration-200 group-hover:text-brand-400" />
      </button>
...
export default function AdminPage() {
  ...
  if (!isLoaded || loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-brand-50/50">
  ...
  if (error && !stats) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-brand-50/50 p-4">
        <div className="max-w-md rounded-2xl border border-red-100 bg-white p-8 text-center shadow-sm">
          ...
          <Link
            href="/"
            className="mt-4 inline-block rounded-xl bg-gompa-slate px-5 py-2.5 text-sm font-medium text-white transition-all duration-200 hover:bg-gray-700"
          >
            Go Home
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-brand-50/50">
      {/* ── Header ──────────────────────────────────────────────── */}
      <header className="sticky top-0 z-30 border-b border-brand-100 bg-gradient-to-r from-brand-50 via-white to-brand-50 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/dashboard"
              className="hidden rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-600 transition-all duration-200 hover:bg-brand-50 hover:border-brand-100 sm:inline-flex sm:items-center sm:gap-1"
            >
            ...
            {user && (
              <Link
                href="/profile"
                className="flex h-8 w-8 items-center justify-center rounded-full bg-brand-50 hover:bg-brand-100 transition-all duration-200 overflow-hidden"
              >
          ...
          {tab === "overview" && stats && (
            ...
            >
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                <div className="rounded-2xl border border-brand-100 bg-white p-5 shadow-sm transition-all duration-200 hover:shadow-md">
                ...
                <div className="rounded-2xl border border-brand-100 bg-white p-5 shadow-sm transition-all duration-200 hover:shadow-md">
                  ...
                  <div className="space-y-3">
                    {stats.topRestaurants.map((r, i) => (
                      <div
                        key={r.id}
                        className="flex items-center gap-3 rounded-xl p-2 transition-all duration-200 hover:scale-[1.01] hover:bg-brand-50/60 hover:shadow-sm"
                      >
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <div className="relative flex-1 sm:max-w-xs">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-white py-2 pl-9 pr-3 text-sm text-gompa-slate placeholder:text-gray-400 transition-all duration-200 focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-200"
                  />
                  {search && (
                    <button
                      type="button"
                      onClick={() => setSearch("")}
                      className="absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400 transition-all duration-200 hover:text-brand-500"
                    >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-xl border border-gray-200 px-3 py-2 text-xs font-medium text-gray-600 transition-all duration-200 hover:bg-brand-50 hover:border-brand-200"
                >
                  <RefreshCw
                  ...
                  <div className="flex items-center justify-between border-t border-gray-100 px-4 py-2.5">
                    ...
                    <div className="flex gap-1.5">
                      <button
                        ...
                        className="rounded-lg border border-gray-200 p-1.5 text-gray-500 transition-all duration-200 hover:bg-brand-50 hover:border-brand-200 disabled:opacity-40"
                      >
