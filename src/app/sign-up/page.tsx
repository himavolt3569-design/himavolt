          ...
          >
            ...
            <div className="flex flex-col gap-4 mb-8">
              ...
              <button
                ...
                className="group flex items-center gap-5 rounded-3xl border border-[var(--border)] bg-white p-5 text-left shadow-sm hover:shadow-md hover:border-[var(--accent)] transition-all duration-300"
              >
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[var(--accent-muted)] text-[var(--accent)] group-hover:scale-110 transition-transform duration-300">
                  <User className="h-7 w-7" />
                </div>
                <div className="flex-1">
                  <h3 className="text-lg font-bold text-[var(--text-1)] mb-1">
                    I am a Customer
                  </h3>
                  <p className="text-sm text-[var(--text-3)] leading-snug">
                    I want to order food, book hotels, and discover places.
                  </p>
                </div>
                <div className="shrink-0 text-[var(--text-3)] group-hover:text-[var(--accent)] transition-colors">
              ...
              <button
                ...
                className="group flex items-center gap-5 rounded-3xl border border-[var(--border)] bg-white p-5 text-left shadow-sm hover:shadow-md hover:border-[var(--text-1)] transition-all duration-300"
              >
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[var(--surface-alt)] text-[var(--text-1)] group-hover:bg-[var(--text-1)] group-hover:text-white group-hover:scale-110 transition-all duration-300">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-[var(--text-3)] leading-snug">
                    I want to list my restaurant/hotel and manage orders.
                  </p>
                </div>
                <div className="shrink-0 text-[var(--text-3)] group-hover:text-[var(--text-1)] transition-colors">
                  <ArrowLeft className="h-6 w-6 rotate-180" />
                </div>
              </button>
            </div>
              ...
              <div>
                ...
                <div className="mt-0.5 flex items-center gap-1.5">
                  ...
                  <span className="text-xs font-semibold text-[var(--text-3)]">
                    {role === "OWNER" ? "Business Account" : "Customer Account"}
                  </span>
                </div>
              </div>
            </div>
                ...
                <div className="flex items-center gap-2">
                  {role === "OWNER" ? (
                    <>
                      ...
                      <span className="text-xs font-bold text-white/90">Setting up Business account</span>
                    </>
                  ) : (
                    <>
                      <UtensilsCrossed className="h-4 w-4 text-[var(--accent)]" />
                      <span className="text-xs font-bold text-[var(--accent-text)]">Setting up Customer account</span>
                    </>
                  )}
                </div>
              </div>
